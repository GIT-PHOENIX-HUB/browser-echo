...
2. **Check the Product Bible** — `PRODUCT_BIBLE.md` defines architectural rules
3. **Check Issue #3** — Architecture target for phoenix-toolbox
4. **Design for Survival** — Every structure must be understandable by a fresh session
5. **Document the Decision** — Write WHY you chose this structure, not just WHAT

## Anti-Patterns
- File-level tunnel vision without considering repo context
